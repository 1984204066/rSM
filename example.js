...
async function iLogin(user, passwd) {
    await page.goto("https://www.mysmth.net/");
    const elementHandle1 = await page.$("input#id");
    await elementHandle1.type(user, { delay: 50 });
    const elementHandle2 = await page.$("input#pwd");
    await elementHandle2.type(passwd, { delay: 50 });
    await page.click("input#b_login");
    await page.waitForNavigation();
}

async function clickBecomeVisible(css1, css2) {
    // await page.evaluate(() => {
